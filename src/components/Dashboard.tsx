    ...
    <div className="min-h-screen bg-gray-50">
      <div className="p-3 sm:p-4 lg:p-6">
        ...
        <div className="flex flex-col space-y-3 mb-4 sm:mb-6">
          <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 text-center sm:text-left">Dashboard</h1>
          ...
          <div className="flex items-center justify-center space-x-3 bg-white rounded-lg p-3 shadow-sm">
            ...
            <span className="text-sm sm:text-base font-medium text-gray-900 min-w-[140px] text-center">
          ...
          <div className="bg-white rounded-lg p-4 shadow-sm text-center">
            <div className="text-xs sm:text-sm text-gray-500 uppercase font-medium mb-1">Saldo do Mês</div>
